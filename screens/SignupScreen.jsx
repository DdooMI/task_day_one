...
function SignupScreen() {
    ...
    return (
        <View style={styles.container}>
            ...
            <ButtonComponent title='Sign Up' subtitle='Already have an account? Log in' press={handleSubmit(onSubmit)} presslogin={()=>navigation.navigate('signup')} />
